<section class="home-section">
    ...
    <main>
        ...
        <div class="container">
          ...
          <?php foreach ($kelurahan as $w) : ?>

          <form action=<?= base_url('administrator/data/update_vaksinasi') ?> method="post">

              <input type="hidden" name="idata_vaccien" class="form-control" value="<?= $w->idata_vaccien ?>">
              ...
              <div class="form_group">
                  ...
                  <input type="text" class="form-control selectric" name="population" id="population" value="<?= $w->population ?>" required>
              ...
              <div class="form_group">
                  ...
                  <input type="text" class="form-control selectric" name="minors1" id="minors1" value="<?= $w->minors1 ?>" required>
                  <?= form_error('minors1', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Lansia</label>
                  <input type="text" class="form-control selectric" name="elderly1" id="elderly1" value="<?= $w->elderly1 ?>" required>
                  <?= form_error('elderly1', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Total Vaksin</label>
                  <input type="text" class="form-control selectric" name="vaccien_1" id="vaccien_1" value="<?= $w->vaccien_1 ?>" required>
                  <?= form_error('vaccien_1', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Tidak Vaksin</label>
                  <input type="text" class="form-control selectric" name="not_vaccine1" id="not_vaccine1" value="<?= $w->not_vaccine1 ?>" required>
              ...
              <div class="form_group">
                  <label>Dibawah Umur</label>
                  <input type="text" class="form-control selectric" name="minors2" id="minors2" value="<?= $w->minors2 ?>" required>
                  <?= form_error('minors2', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Lansia</label>
                  <input type="text" class="form-control selectric" name="elderly2" id="elderly2" value="<?= $w->elderly2 ?>" required>
                  <?= form_error('elderly2', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Total Vaksin</label>
                  <input type="text" class="form-control selectric" name="vaccien_2" id="vaccien_2" value="<?= $w->vaccien_2 ?>" required>
                  <?= form_error('vaccien_2', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Tidak Vaksin</label>
                  <input type="text" class="form-control selectric" name="not_vaccine2" id="not_vaccine2" value="<?= $w->not_vaccine2 ?>" required>
              ...
              <div class="form_group">
                  <label>Dibawah Umur</label>
                  <input type="text" class="form-control selectric" name="minors3" id="minors3" value="<?= $w->minors3 ?>" required>
                  <?= form_error('minors3', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Lansia</label>
                  <input type="text" class="form-control selectric" name="elderly3" id="elderly3" value="<?= $w->elderly3 ?>" required>
                  <?= form_error('elderly3', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Total Vaksin</label>
                  <input type="text" class="form-control selectric" name="vaccien_3" id="vaccien_3" value="<?= $w->vaccien_3 ?>" required>
                  <?= form_error('vaccien_3', '<small class="text-danger">', '</small>'); ?>
              </div>
              <div class="form_group">
                  <label>Tidak Vaksin</label>
                  <input type="text" class="form-control selectric" name="not_vaccine3" id="not_vaccine3" value="<?= $w->not_vaccine3 ?>" required>
