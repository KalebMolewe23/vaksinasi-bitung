<section class="home-section">
  ...
  <main>
    ...
    <a href="<?= base_url("administrator/data/tambah_vaksinasi"); ?>"><button class="btn btn-success" type="button"><i class='bx bxs-file-plus'></i> Tambah Data</button></a>
    <br><br>
    <form action="<?= base_url('administrator/data/deleteall_vaksinasi') ?>" method="POST">
            ...
            <tbody>
                ...
                foreach ($data_vaccine->result() as $inv) : ?>
                    <tr>
                        ...
                        <td align="center">
                        <?= anchor('administrator/data/edit_vaksinasi/' . $inv->idata_vaccien, '<div class="btn btn-primary btn-sm"><i class="bx bx-edit" ></i> Ubah</div>') ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
